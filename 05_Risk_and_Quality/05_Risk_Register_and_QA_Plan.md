...
| :--- | :--- | :--- | :---: | :---: | :---: | :--- | :--- | :---: |
| **RSK-01** | Technical | Twilio Video latency/call drop on slow 3G/4G patient connections | 4 | 4 | **16 (High)** | Implemented automatic bitrate downscaling and 120s auto-reconnect fallback without session drop. | Ranjith (Lead Dev) | [Mitigated] |
| **RSK-02** | Compliance | HIPAA Non-Compliance penalty risk during video & data transfer | 2 | 5 | **10 (Med)** | Contracted certified external HIPAA auditor; enforced AES-256 encryption at rest and TLS 1.3 in transit. | Numesh (IT PM) | [Closed] |
| **RSK-03** | Scope Creep | Sponsor requesting automated insurance billing integration during Sprint 3 | 4 | 4 | **16 (High)** | Enforced Scope Management procedure: deferred insurance claims to Version 2.0 with formal sponsor sign-off. | Numesh (IT PM) | [Resolved] |
| **RSK-04** | Resource | Mobile Developer unavailable due to illness in Sprint 2 | 3 | 3 | **9 (Med)** | Re-allocated backend dev to assist with API contracts; paired frontend dev on shared logic. | Numesh (IT PM) | [Resolved] |
| **RSK-05** | External | Apple App Store review rejection due to medical privacy guidelines | 3 | 4 | **12 (Med)** | Conducted pre-submission compliance audit against Apple Guideline 5.1 (Medical/Health Apps) prior to release. | Nadeeka (QA Lead) | [Closed] |
...
| **End-to-End (E2E) Testing** | Booking to Video Call to Prescription PDF & Pharmacy | 100% | 100% | [Signed Off] |
| **Security & Penetration** | OWASP Top 10, HIPAA Encryption | 100% | 100% | [Signed Off] |
| **Cross-Device Usability** | iOS & Android devices (Multiple resolutions) | 95% | 98.6% | [Signed Off] |
