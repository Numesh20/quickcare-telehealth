...
[Week 10-11] Sprint 4: Digital Prescriptions, Notifications & MVP Polish
...
* **Stories Included:**
  ...
  * `US-401`: Stripe Payment SDK Integration (Credit/Debit, Apple Pay) (5 pts)
...
### 🏃 Sprint 4: Prescriptions & End-to-End Polish
* **Sprint Goal:** Enable doctors to issue PDF prescriptions and complete end-to-end MVP.
* **Committed Points:** 29 | **Completed Points:** 29
* **Stories Included:**
  * `US-501`: Doctor Digital Prescription Builder & Signature (5 pts)
  ...
  * `TECH-401`: End-to-End Performance Optimization & Memory Leak Fixes (8 pts)
  * `QA-401`: Full Regression Testing across iOS 17 & Android 14 (7 pts)
* **Sprint Velocity:** 29 Points
...
* **Average Velocity:** 30 Story Points / Sprint
* **Predictability Rate:** 96.7% (High delivery reliability)
...
| :--- | :--- | :--- | :--- | :--- |
| **Day 4 (Sprint 3)** | iOS Developer | Completed Stripe Payment Sheet UI | Connect Stripe test token to AWS backend | **Blocker:** Missing Stripe Sandbox API test keys. <br>➡️ *PM Action: Requested and shared keys from Tech Lead in 15 mins.* |
| **Day 7 (Sprint 3)** | Backend Lead | Completed Twilio Video Room Webhook | Integrate reconnection logic on network drop | None |
| **Day 9 (Sprint 3)** | QA Lead | Executed 15 test cases for video calling | Test call drop behavior under 3G throttling | None |
